...
{
buf.push("<div" + (jade.attr("style", 'background-image:url("' + (board.primaryMedia.content) + '")', true, false)) + " class=\"rewardImg\"></div>");
}
...
buf.push("<div" + (jade.cls(['boardZone','attemptZone','' + (attempt.state) + ''], [null,null,true])) + "><div class=\"gameHeader\"><div class=\"gameCreator\"><div" + (jade.attr("style", 'background-image:url("' + (attempt.user.profilePic) + '")', true, false)) + " class=\"face\"></div></div><div class=\"gameMeta\"><div class=\"playerName gameMetaText\">");
