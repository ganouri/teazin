...
{
buf.push("<div" + (jade.attr("style", 'background-image:url("' + (face.profilePic.path) + '")', true, false)) + (jade.attr("faceId", '' + (face.id) + '', true, false)) + (jade.attr("mediaId", '' + (face.profilePic.id) + '', true, false)) + (jade.cls(['face','' + (room.viewConfig.facesView) + ''], [null,true])) + "></div>");
}
    }
