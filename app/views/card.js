...
{
buf.push("<div" + (jade.attr("style", 'background-image:url("' + (card.primaryMedia.path) + '")', true, false)) + (jade.attr("mediaId", '' + (card.primaryMedia.id) + '', true, false)) + " class=\"rewardImg\"></div>");
}
