...
{
buf.push("<div" + (jade.attr("style", 'background-image:url("' + (card.primaryMedia.path) + '")', true, false)) + (jade.attr("mediaId", '' + (card.primaryMedia.id) + '', true, false)) + (jade.attr("loading", '' + (card.primaryMedia.path) + '', true, false)) + " class=\"rewardImg\"></div>");
}
